...
let g:coc_snippet_prev = '<c-r>'

" Use <C-space> for both expand and jump (make expand higher priority.)
...
nnoremap <silent> <CR>b  :<C-u>CocList -I symbols<cr>
" Do default action for next item.
nnoremap <silent> <CR>n  :<C-u>CocNext<CR>
